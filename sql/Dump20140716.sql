...
INSERT INTO `tb_admin` VALUES ('admin','admin','管理员'),('root','root','root'),('xm','xm','总经理');
...
INSERT INTO `tb_role` VALUES ('root','[\"登录\",\"管理员管理\",\"用户管理\",\"卖家管理\",\"商店管理\",\"文章管理\",\"链接管理\",\"商品管理\",\"上传文件\"]'),('管理员','[\"登录\",\"管理员管理\",\"用户管理\",\"卖家管理\",\"商店管理\",\"文章管理\",\"链接管理\",\"商品管理\"]');
...
-- Dump completed on 2014-07-16  1:39:39
